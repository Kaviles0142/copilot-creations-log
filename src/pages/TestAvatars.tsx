...
const DITTO_WS_URL = 'wss://mx44t4geabt131-8000.proxy.runpod.net/ws/stream';

export default function TestAvatars() {
  const [imageUrl, setImageUrl] = useState<string | null>(null);
  const [imageBase64, setImageBase64] = useState<string | null>(null);
  const [isGeneratingImage, setIsGeneratingImage] = useState(false);
  const [text, setText] = useState('Hello, I am Albert Einstein. The important thing is not to stop questioning. Curiosity has its own reason for existence.');
