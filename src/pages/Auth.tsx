    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-card border-r border-border">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] rounded-full bg-primary/5 blur-[100px]" />
        </div>
        <div className="relative z-10 flex flex-col justify-center px-16">
          <Link to="/" className="flex items-center gap-3 mb-12">
            ...
            <span className="font-display text-2xl font-semibold text-foreground">Never Gone</span>
          </Link>
          <h2 className="font-display text-4xl font-bold text-foreground mb-4">
            Step into history.
          </h2>
          <p className="text-lg text-muted-foreground max-w-md">
            Engage in meaningful conversations with humanity's greatest minds across time.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-sm">
            ...
            <h1 className="font-display text-2xl font-bold mb-2 text-center lg:text-left">
            ...
            <div className="space-y-3 mb-6">
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 border-border hover:bg-card"
